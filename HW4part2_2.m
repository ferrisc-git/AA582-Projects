...
myFolder = 'C:\Users\Casey Ferris\Documents\MATLAB\HW4Part2.2';
...
myFolder = 'C:\Users\Casey Ferris\Documents\MATLAB\HW4Part2.2';
filePattern2 = fullfile(myFolder, 'Deth*');
...
myFolder = 'C:\Users\Casey Ferris\Documents\MATLAB\HW4Part2.2';
filePattern3 = fullfile(myFolder, 'Lost*');
...
title('Metal bands');
subplot(3,1,2),(bar(proj2(2:15))), xlim([0 15]), ylim([-0.4 0.4]), xlabel('PCA modes'), ylabel('Covariance'), text(12,0.1, 'Dethklok', 'Fontsize', [10])
subplot(3,1,3),(bar(proj3(2:15))), xlim([0 15]), ylim([-0.4 0.4]), xlabel('PCA modes'), ylabel('Covariance'), text(12,0.1, 'Lost Horizon', 'Fontsize', [10])
