...
myFolder = 'C:\Users\Casey Ferris\Documents\MATLAB\HW4Part2.3\Metal';
filePattern1 = fullfile(myFolder, 'metal*');
...
myFolder = 'C:\Users\Casey Ferris\Documents\MATLAB\HW4Part2.3\80s pop';
filePattern2 = fullfile(myFolder, 'pop*');
...
myFolder = 'C:\Users\Casey Ferris\Documents\MATLAB\HW4Part2.3\Orchestra';
filePattern3 = fullfile(myFolder, 'orchestra*');
...
proj3=vec3*V;
figure(1)
subplot(3,1,1),(bar(proj1(2:15))), xlim([0 15]), ylim([-0.4 0.4]), xlabel('PCA modes'), ylabel('Covariance'), text(12,0.1, 'Metal', 'Fontsize', [10])
title('3 Different Genres');
subplot(3,1,2),(bar(proj2(2:15))), xlim([0 15]), ylim([-0.4 0.4]), xlabel('PCA modes'), ylabel('Covariance'), text(12,0.1, '80s Pop', 'Fontsize', [10])
subplot(3,1,3),(bar(proj3(2:15))), xlim([0 15]), ylim([-0.4 0.4]), xlabel('PCA modes'), ylabel('Covariance'), text(12,0.1, 'Orchestrated', 'Fontsize', [10])
